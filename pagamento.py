...
class CartaoCredito(Pagamento):
    ...
    def processar_pagamento(self, valor):
        print("€" + format(valor, ".2f") + " com Cartão de Crédito (" + self.numero_cartao + ")")
...
class PayPal(Pagamento):
    ...
    def processar_pagamento(self, valor):
        print("€" + format(valor, ".2f") + " com PayPal (e-mail: " + self.email + ")")
...
class TransferenciaBancaria(Pagamento):
    ...
    def processar_pagamento(self, valor):
        print("€" + format(valor, ".2f") +
              " com Transferência Bancária (banco: " + self.banco +
              ", conta: " + self.conta + ")")
